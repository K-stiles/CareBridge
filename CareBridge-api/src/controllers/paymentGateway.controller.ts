...
/** create Payment */
export async function paymentConfirmationCallback(req: Request<{}, {}, CreatePaymentInput["body"]>, res: Response) {
...
/** get all Payment */
export const processPayment = async (req: Request<ReadPaymentInput["params"]>, res: Response, next: NextFunction) => {
